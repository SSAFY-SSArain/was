...
public record BrainFoundDto(
    ...
    public static BrainFoundDto from(Brain brain, String adminName, List<String> memberNames) {
        return new BrainFoundDto(brain.getBid(), brain.getName(), adminName, brain.getDescription(), memberNames);
    }
}
